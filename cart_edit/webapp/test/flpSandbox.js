		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cart Edit",
									"targetURL": "#sync6cl1cartedit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1cartedit-display": {
								"semanticObject": "sync6cl1cartedit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.cartedit",
									"url": sap.ui.require.toUrl("sync6/cl1/cartedit")
								}
							}
						}
					}
