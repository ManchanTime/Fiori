		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight Chart Info",
									"targetURL": "#sync6cl1chartflight-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1chartflight-display": {
								"semanticObject": "sync6cl1chartflight",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.chartflight",
									"url": sap.ui.require.toUrl("sync6/cl1/chartflight")
								}
							}
						}
					}
