		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test16",
									"targetURL": "#cl1test16cl1test16-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl1test16cl1test16-display": {
								"semanticObject": "cl1test16cl1test16",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl1.test16.cl1.test16",
									"url": sap.ui.require.toUrl("cl1/test16/cl1/test16")
								}
							}
						}
					}
