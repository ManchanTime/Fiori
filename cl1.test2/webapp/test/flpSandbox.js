		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Rap Test",
									"targetURL": "#cl1test2cl1test2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl1test2cl1test2-display": {
								"semanticObject": "cl1test2cl1test2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl1.test2.cl1.test2",
									"url": sap.ui.require.toUrl("cl1/test2/cl1/test2")
								}
							}
						}
					}
