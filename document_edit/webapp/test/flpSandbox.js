		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Document edit",
									"targetURL": "#sync6cl1documentedit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1documentedit-display": {
								"semanticObject": "sync6cl1documentedit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.documentedit",
									"url": sap.ui.require.toUrl("sync6/cl1/documentedit")
								}
							}
						}
					}
