		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight",
									"targetURL": "#sync6cl1flight16-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1flight16-display": {
								"semanticObject": "sync6cl1flight16",
								"action": "display",
								"description": "Flight",
								"title": "Flight",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.flight16",
									"url": sap.ui.require.toUrl("sync6/cl1/flight16")
								}
							}
						}
					}
