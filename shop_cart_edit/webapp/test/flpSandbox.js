		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Shopping Cart Edit",
									"targetURL": "#sync6cl1shopcartedit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1shopcartedit-display": {
								"semanticObject": "sync6cl1shopcartedit",
								"action": "display",
								"description": "Shopping Cart Edit",
								"title": "Shopping Cart Edit",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.shopcartedit",
									"url": sap.ui.require.toUrl("sync6/cl1/shopcartedit")
								}
							}
						}
					}
