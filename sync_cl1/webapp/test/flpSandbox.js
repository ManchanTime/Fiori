		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synccl1synccl1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccl1synccl1-display": {
								"semanticObject": "synccl1synccl1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.cl1.synccl1",
									"url": sap.ui.require.toUrl("sync/cl1/synccl1")
								}
							}
						}
					}
