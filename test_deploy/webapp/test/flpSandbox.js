		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TestDeploy",
									"targetURL": "#testdeploytestdeploy-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testdeploytestdeploy-display": {
								"semanticObject": "testdeploytestdeploy",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testdeploy.testdeploy",
									"url": sap.ui.require.toUrl("testdeploy/testdeploy")
								}
							}
						}
					}
