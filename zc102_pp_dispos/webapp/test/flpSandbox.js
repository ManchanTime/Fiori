		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "폐기율 조회",
									"targetURL": "#zc102ppdisposzc102ppdispos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc102ppdisposzc102ppdispos-display": {
								"semanticObject": "zc102ppdisposzc102ppdispos",
								"action": "display",
								"description": "폐기율 조회",
								"title": "폐기율 조회",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc102ppdispos.zc102ppdispos",
									"url": sap.ui.require.toUrl("zc102ppdispos/zc102ppdispos")
								}
							}
						}
					}
