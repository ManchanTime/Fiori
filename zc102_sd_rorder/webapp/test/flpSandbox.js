		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "정기 주문 관리",
									"targetURL": "#zc102sdrorderzc102sdrorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc102sdrorderzc102sdrorder-display": {
								"semanticObject": "zc102sdrorderzc102sdrorder",
								"action": "display",
								"description": "[SD] 정기 구문 관리",
								"title": "정기 주문 관리",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc102sdrorder.zc102sdrorder",
									"url": sap.ui.require.toUrl("zc102sdrorder/zc102sdrorder")
								}
							}
						}
					}
